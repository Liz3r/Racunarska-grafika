...
BEGIN_MESSAGE_MAP(CAutoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAutoApp::OnAppAbout)
...
CAutoApp::CAutoApp() noexcept
{
	...
	SetAppID(_T("Auto.AppID.NoVersion"));
